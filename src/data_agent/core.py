...
# Управляет полным циклом подготовки датасетов для AutoML
class DataAgent:
    def __init__(
        self,
    ...
    # Выполняет обработку всех зарегистрированных датасетов и возвращает пути артефактов
    ...
    # Запрашивает рекомендации препроцессинга у LLM-клиента
